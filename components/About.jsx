...
const About = () => {
  return (
    <div className='w-full bg-black text-center text-white'>
        <div className='max-w-[1240px] mx-auto py-16 bg-black'>
            <h1 className='py-4'>A Growing Protocol Ecosystem</h1>
            <p className='py-4 text-2xl'>The Rudya protocol system empowers developers, liquidity providers,
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
            ...
            <AboutCard icon={<SiStrapi size={40}/>} heading="Proven, ready-made solutions" text="Integrate pre-built, time-tested oracle solutions that already 
            secure tens of billions in smart contract value for market-leading decentralized applications."/>
            <AboutCard icon={<SiFsecure size={40}/>} heading="Seamless connection to any API" text="Build on a flexible framework that can retrieve data from any API, 
            connect with existing systems, and integrate with any current or future blockchain."/>
            <AboutCard icon={<VscServerProcess size={40}/>} heading="Secure off-chain computation" text="Use a decentralized network of DeFi Keeper nodes to automate contracts, 
